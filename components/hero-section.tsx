    ...
    <>
      <main>
        <section className="overflow-hidden">
          <div className="relative mx-auto max-w-7xl px-6 py-28 lg:py-20 lg:pl-20">
            ...
            <div className="absolute inset-0 -mx-4 rounded-3xl p-3 lg:col-span-3">
              <div className="relative">
                <div className="bg-radial-[at_75%_30%] to-background z-1 -inset-17 absolute from-transparent to-42% "></div>
                <Image
                  className="hidden dark:block"
                  src="https://i.postimg.cc/B6Vcr8XP/Blank-diagram-9.png"
